...
namespace WpfApp.Mvvm.ViewModels
{
    public partial class ContactEditViewModel : ObservableObject
    {
        ...
        public ContactEditViewModel(IServiceProvider serviceProvider, ContactService contactService, IFileService fileService)
        {
        ...
        public void Add()
        {
            try
            {
                // Make sure contact has the correct ID.
